...
public class CloudSim {
	...
	private static double minTimeBetweenEvents = 0.0; //0.001

	/** The cloud type (CloudSimTags.DoS, CloudSimTags.EDoS, EDoS_Algorithm)  */
	private static int cloudType = CloudSimTags.EDoS;

	/** The load balancing policy (CloudSimTags.ROUND_ROBIN, CloudSimTags.LEAST_LOADED)  */
	private static int loadBalancingPolicy = CloudSimTags.ROUND_ROBIN;

	/** Initial number of vms **/
	private static int initialVMsCount = 5;

	/** Rate of Legitimate Requests **/
	private static int legitimateRequestsRate = 200;

	/** Rate of Attack Requests **/
	private static int attackRequestsRate = 0;

	/** Load Balancer service rate **/
	private static double loadBalancerServiceRate = 172413.79310344827586206896551724;

	/** web servers service rate **/
	private static double webServersServiceRate = 100.0;

	/** The maximum number of VMs than can be exist in the cloud */
	private static long vmsCountUpperThr = 200;

	/** The minimum number of VMs than can be exist in the cloud */
	private static long vmsCountLowerThr = 5;

	/** The cloud mode (CloudSimTags.Normal_Mode, CloudSimTags.Suspicion_Mode, CloudSimTags.Flash_Overcrowd_Mode, CloudSimTags.Attack_Mode)  */
	private static int cloudMode = CloudSimTags.Normal_Mode;

	///////////////////// SCALE UP /////////////////////////////////////////////

	/** The cpu utilization thre. */
	private static double scaleUpCpuUtilizationThr = 80.0;

	/** The cpu utilization thre. */
	private static double scaleUpCpuUtilizationLowerThr = 75.0;

	/** The cpu utilization thre. time */
	private static double scaleUpTimer = 5*60;

	/** The lower cpu utilization thre. time */
	private static double scaleUpLowerTimer = 1*60;

	/** The time when cpu utilization breaks the thre. */
	private static double timeBreakScaleUpCpuUtilizationThr = -1.0;

	/** The time when cpu utilization breaks the lower thre. */
	private static double timeBreakScaleUpCpuUtilizationLowerThr = -1.0;

	///////////////////// SCALE DOWN /////////////////////////////////////////////

	/** The cpu utilization thre. */
	private static double scaleDownCpuUtilizationThr = 30.0;

	/** The cpu utilization thre. */
	private static double scaleDownCpuUtilizationUpperThr = 35.0;

	/** The cpu utilization thre. time */
	private static double scaleDownTimer = 5*60;

	/** The lower cpu utilization thre. time */
	private static double scaleDownUpperTimer = 1*60;

	/** The time when cpu utilization breaks the thre. */
	private static double timeBreakScaleDownCpuUtilizationThr = -1.0;

	/** The time when cpu utilization breaks the lower thre. */
	private static double timeBreakScaleDownCpuUtilizationUpperThr = -1.0;

	///////////////////// Suspicion Sell //////////////////////////////////////////

	private static double suspicionTimer = getScaleUpTimer();

	/** The time when suspicion shell started */
	private static double suspicionTimerStarts = -1.0;

	private static int RPSThreshold = 4;

	///////////////////// Trust Factor //////////////////////////////////////////

	private static double TFCoefficientOfVariation = 1.0;

	///////////////////// Attack Sell //////////////////////////////////////////

	private static int attackTimeDuration = 30*60; // 30 min.

	private static double dynamicAttackTimeDuration;

	/** The time when attack shell started */
	private static double attackTimerStarts = -1.0;

	//////////////////////////// Auto Scaling ///////////////////////////////////////////////////

	private static int autoScalingSize = 2;

	private static double provisioningOverhead = 55.4;

	//////////////////////////// reCAPTCHA ///////////////////////////////////////////////////

	private static double reCAPTCHAOverhead = 13.06;

	private static double redirection = 0.63;
	...
	/**
	 * Returns load balancing policy.
	 * @return the load balancing policy.
	 */
	public static int getLoadBalancingPolicy() {
		return loadBalancingPolicy;
	}

	/**
	 * Returns number of requests that can be served in unit time.
	 * @return the number of requests that can be served in unit time .
	 */
	public static double getLoadBalancerServiceRate() {
		return loadBalancerServiceRate;
	}
	 ...
	 * @return the number of requests that can be served in unit time .
	 */
	public static double getWebServersServiceRate() {
		return webServersServiceRate;
	}

	/** Initial number of vms */

	/**
	 * Returns number of initial vms
	 * @return the number of initial vms .
	 */
	public static int getInitialVMsCount() {
		return initialVMsCount;
	}

	/** Rate of Legitimate Requests */

	/**
	 * Returns Rate of Legitimate Requests
	 * @return Rate of Legitimate Requests
	 */
	public static int getLegitimateRequestsRate() {
		return legitimateRequestsRate;
	}

	public static void setAttackRequestsRate(int i) {
		attackRequestsRate = i;
	}

	/** Rate of Attack Requests */

	/**
	 * Returns Rate of Attack Requests
	 * @return Rate of Attack Requests
	 */
	public static int getAttackRequestsRate() {
		return attackRequestsRate;
	}

	/** Rate of Incoming Requests */

	/**
	 * Returns Rate of Incoming Requests
	 * @return Rate of Incoming Requests
	 */
	public static int getIncomingRequestsRate() {
		return getLegitimateRequestsRate() + getAttackRequestsRate();
	}

	/**
	 * Returns maximum number of VMs than can be exist in the cloud.
	 * @return the maximum number of VMs than can be exist in the cloud.
	 */
	public static long getVmsCountUpperThr() {
		return vmsCountUpperThr;
	}

	/**
	 * Returns minimum number of VMs than can be exist in the cloud.
	 * @return the minimum number of VMs than can be exist in the cloud.
	 */
	public static long getVmsCountLowerThr() {
		return vmsCountLowerThr;
	}

	/**
	 * Returns the time when cpu utilization breaks the thre.
	 * @return the time when cpu utilization breaks the thre.
	 */
	public static int getCloudMode() {
		return cloudMode;
	}

	public static void setCloudMode(int mode) {
		cloudMode = mode;
	}
	...
	//Ahmad
	/**
	 * Returns CPU Utilization Thre
	 * @return the CPU Utilization Threshold
	 */
	public static double getScaleUpCpuUtilizationThr() {
		return scaleUpCpuUtilizationThr;
	}

	//Ahmad
	/**
	 * Returns Lower CPU Utilization Thre
	 * @return the lower CPU Utilization Threshold
	 */
	public static double getScaleUpLowercpuUtilizationThr() {
		return scaleUpCpuUtilizationLowerThr;
	}

	//Ahmad
	/**
	 * Returns CPU Utilization Threshold Time
	 * @return CPU Utilization Threshold Time
	 */
	public static double getScaleUpTimer() {
		return scaleUpTimer;
	}

	//Ahmad
	/**
	 * Returns Lower CPU Utilization Threshold Time
	 * @return Lower CPU Utilization Threshold Time
	 */
	public static double getScaleUpLowerTimer() {
		return scaleUpLowerTimer;
	}
	 ...
	 * @return the time when cpu utilization breaks the thre.
	 */
	public static double getTimeBreakScaleUpCpuUtilizationThr() {
		return timeBreakScaleUpCpuUtilizationThr;
	}
	public static void setTimeBreakScaleUpCpuUtilizationThr(double time) {
		timeBreakScaleUpCpuUtilizationThr = time;
	}

	//Ahmad
	/**
	 * Returns the time when cpu utilization breaks the lower thre.
	 * @return the time when cpu utilization breaks the lower thre.
	 */
	public static double getTimeBreakScaleUpCpuUtilizationLowerThr() {
		return timeBreakScaleUpCpuUtilizationLowerThr;
	}
	public static void setTimeBreakScaleUpCpuUtilizationLowerThr(double time) {
		timeBreakScaleUpCpuUtilizationLowerThr = time;
	}
	...
	public static double getScaleDownCpuUtilizationThr() {
		return scaleDownCpuUtilizationThr;
	}

	public static double getScaleDownUppercpuUtilizationThr() {
		return scaleDownCpuUtilizationUpperThr;
	}

	public static double getScaleDownTimer() {
		return scaleDownTimer;
	}

	public static double getScaleDownUpperTimer() {
		return scaleDownUpperTimer;
	}

	public static double getTimeBreakScaleDownCpuUtilizationThr() {
		return timeBreakScaleDownCpuUtilizationThr;
	}

	public static void setTimeBreakScaleDownCpuUtilizationThr(double time) {
		timeBreakScaleDownCpuUtilizationThr = time;
	}

	public static double getTimeBreakScaleDownCpuUtilizationUpperThr() {
		return timeBreakScaleDownCpuUtilizationUpperThr;
	}
	public static void setTimeBreakScaleDownCpuUtilizationUpperThr(double time) {
		timeBreakScaleDownCpuUtilizationUpperThr = time;
	}

	//////////////////////////////// Suspicion Shell FUNCTIONS //////////////////////////////

	//Ahmad

	public static double getSuspicionTimer() {
		return suspicionTimer;
	}

	public static double getSuspicionTimerStarts() {
		return suspicionTimerStarts;
	}

	public static void setSuspicionTimerStarts(double time) {
		suspicionTimerStarts = time;
	}

	public static int getMRPS() {
		return RPSThreshold;
	}

	//////////////////////////////// Trust Factor FUNCTIONS //////////////////////////////

	public static double getTFCoefficientOfVariation() {
		return TFCoefficientOfVariation;
	}

	//////////////////////////////// Attack Shell FUNCTIONS //////////////////////////////

	//Ahmad

	public static void setAttackDuration(double percentage) {
		dynamicAttackTimeDuration = attackTimeDuration * percentage;
	}

	public static double getAttackDuration() {
		return dynamicAttackTimeDuration;
	}

	public static double getAttackTimerStarts() {
		return attackTimerStarts;
	}

	public static void setAttackTimerStarts(double time) {
		attackTimerStarts = time;
	}
	...
	public static void setInitialVMsCount(int i) {
		initialVMsCount = i;
	}

	public static int getAutoScalingSize() {
		return autoScalingSize;
	}

	public static double getProvisioningOverhead() {
		return provisioningOverhead;
	}


	public static double getreCAPTCHAOverhead() {
		return reCAPTCHAOverhead;
	}

	public static double getRedirectionOverhead() {
		return redirection;
	}
