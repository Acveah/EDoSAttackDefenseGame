...
public class CloudSimTags {
	...
	// Ahmad
	public static final int CLOUD_SCALE_UP = BASE + 49;

	public static final int CLOUD_SCALE_DOWN = BASE + 50;

	public static final int ROUND_ROBIN = BASE + 51;

	public static final int LEAST_LOADED = BASE + 52;

	public static final int DoS = BASE + 53;

	public static final int EDoS = BASE + 54;

	public static final int EDoS_Algorithm = BASE + 55;

	public static final int Normal_Mode = BASE + 56;

	public static final int Suspicion_Mode = BASE + 57;

	public static final int Flash_Overcrowd_Mode = BASE + 58;

	public static final int Attack_Mode = BASE + 59;

	public static final int Check_Average_CPU_Utilization = BASE + 60;

	public static final int Rate_Repetition = BASE + 61;

	public static final int Finishing_Cloudlet = BASE + 62;

	public static final int Send_to_Cloud_Servers = BASE + 63;

	public static final int Check_Average_CPU_Utilization_every_second = BASE + 64;

	public static final int Check_Average_RAM_Utilization_every_second = BASE + 65;

	public static final int Check_Average_RAM_Utilization = BASE + 66;
