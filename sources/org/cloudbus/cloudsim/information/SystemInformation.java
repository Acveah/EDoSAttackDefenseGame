...
public class SystemInformation {
	 ...
	 * @param utilization
	 */
	public SystemInformation(int time, int vmCount, double utilization, double utilizationRAM,double responseTime, double throughput) {
		setTime(time);
		setVMCount(vmCount);
		setUtilization(utilization);
		setUtilizationRAM(utilizationRAM);
